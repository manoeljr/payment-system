...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendVerificationEmail(User user) throws MessagingException, UnsupportedEncodingException {
        String toSendForAddress = user.getEmail();
        String fromAddress = "manoelv8@gmail.com";
        String sendForName = "Payments";
        String subject = "Please verify your registration email";
        ...
        helper.setFrom(fromAddress, sendForName);
        helper.setTo(toSendForAddress);
